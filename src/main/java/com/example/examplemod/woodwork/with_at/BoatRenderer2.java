...
@OnlyIn(Dist.CLIENT)
public class BoatRenderer2 extends EntityRenderer<Boat2> {
    ...
    public BoatRenderer2(EntityRendererProvider.Context context) {
        super(context);
    ...
    public void render(Boat2 pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
    ...
    public ResourceLocation getTextureLocation(Boat2 pEntity) {
        return getModelWithLocation(pEntity).getFirst();
    }

    public Pair<ResourceLocation, BoatModel> getModelWithLocation(Boat2 boat) {
